...
État vérifié le **18 août 2026**. Les mentions distinguent **[Officiel]** recommandation publiée par un fournisseur, **[Consensus]** pratique convergente entre plusieurs fournisseurs et **[Déduction]** conclusion analytique de cet observatoire.

> ⚠️ **Six points d’attention du contrôle du 18 août 2026.**
>
> **1. Le prix d’un modèle dépend du canal de facturation, et deux pages officielles peuvent se contredire** [Officiel]. Le 18 août 2026, la page tarifaire d’Anthropic énonce que la hausse de **Claude Sonnet 5** vers 3/15 USD par million de jetons, programmée au 1er septembre, **n’aura pas lieu** ; la grille des modèles partenaires de **Google Cloud**, lue le même jour, affiche toujours « Standard Price beginning September 1st, 2026 » à **3,00/15,00 USD/M**, et **3,30/16,50** sur les endpoints non globaux. La pratique qui en découle est simple et vaut au-delà de ce cas précis : **la source de vérité d’un prix est la page tarifaire du fournisseur qui vous facture**, pas celle de l’éditeur du modèle. Un cloud partenaire redistribue un modèle sous ses propres conditions et selon son propre calendrier — la page d’Anthropic l’écrit elle-même en marquant plusieurs modèles « retired, except on Bedrock and Google Cloud ». **[Déduction]** Inscrivez au calendrier une relecture de la grille de votre distributeur avant toute échéance annoncée, et ne reportez jamais sur lui une annonce faite par l’éditeur du modèle.
>
