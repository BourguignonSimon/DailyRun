...
État vérifié le **19 août 2026**. Les mentions distinguent **[Officiel]** recommandation publiée par un fournisseur, **[Consensus]** pratique convergente entre plusieurs fournisseurs et **[Déduction]** conclusion analytique de cet observatoire.

> ⚠️ **Six points d’attention du contrôle du 19 août 2026.**
>
> **1. La source de vérité d’un prix est la page du fournisseur qui vous facture, et elle peut être en retard sur celle de l’éditeur** [Officiel]. Le 18 août 2026, la page tarifaire d’Anthropic énonçait que la hausse de **Claude Sonnet 5** vers 3/15 USD par million de jetons, programmée au 1er septembre, **n’aurait pas lieu**, tandis que la grille des modèles partenaires de **Google Cloud** affichait encore « Standard Price beginning September 1st, 2026 » à **3,00/15,00 USD/M**. Le 19 août, la même grille affiche **2,00/10,00 USD/M** en global et **2,20/11,00** en non global, sans échéance : elle s’est alignée en un jour. L’épisode ne dément pas la pratique, il la fonde — **la source de vérité d’un prix est la page tarifaire du fournisseur qui vous facture**, pas celle de l’éditeur du modèle, et un écart entre les deux se lit comme un décalage de mise à jour possible autant que comme une décision commerciale. Un cloud partenaire redistribue un modèle sous ses propres conditions et selon son propre calendrier — la page d’Anthropic l’écrit elle-même en marquant plusieurs modèles « retired, except on Bedrock and Google Cloud ». **[Déduction]** Inscrivez au calendrier une relecture de la grille de votre distributeur avant toute échéance annoncée, et ne reportez jamais sur lui une annonce faite par l’éditeur du modèle.
>
