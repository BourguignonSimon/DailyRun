...
Mise à jour: **21 juillet 2026** (base: 17 juillet). Ce fichier remplace le classeur Excel demandé initialement: le dépôt a explicitement migré vers Markdown le 16 juillet 2026. Les « feuilles » sont les sections ci-dessous. Les références Sxx renvoient à [sources.md](sources.md). Changements du 21 juillet: OpenAI GPT-5.6 Sol, Anthropic Fable 5/Mythos 5, Gemma 4 Apache 2.0, jalon AI Act du 2 août.
...
| 2 | Anthropic | Modèles + app + API + agent code | Fable 5, Opus 4.8, Sonnet 5, Claude Code | Élevée | Raisonnement, code, long contexte | Prix Fable/Opus; options régionales payantes | S06–S08, S62 |
...
|---|---:|---:|---:|---:|---:|---:|---|---|---|
| OpenAI GPT-5.6 Sol | À confirmer (403 proxy) | 5 USD | À confirmer | 30 USD | 4,38 € | 26,30 € | Classes à reconfirmer | Nouvelle série Sol/Terra/Luna; contexte/cache à revérifier | S61 |
| OpenAI GPT-5.5 (précédent phare) | 1,05 M | 5 USD | 0,50 USD | 30 USD | 4,38 € | 26,30 € | Batch/Flex -50 %; Priority ×2,5 | >272 k: entrée ×2, sortie ×1,5; outils séparés | S01–S02 |
| Anthropic Claude Fable 5, API directe | 1 M | 10 USD | selon cache | 50 USD | 8,77 € | 43,84 € | Batch -50 % | Modèle le plus capable (GA 09/06); raisonnement adaptatif toujours actif | S62 |
...
| Anthropic Claude Sonnet 5 | 1 M | 2 USD intro | selon cache | 10 USD intro | 1,75 € | 8,77 € | Batch -50 % | Intro 2/10 jusqu’au 31/08/2026; standard 3/15 | S62 |
...
| Google | texte, image, audio, vidéo selon modèle | Oui | Search/Maps | File search/cache | Managed agents, ADK | Python, JS, Go, Java | Gemma 4 séparé, Apache 2.0 | 1 M |
...
Les benchmarks fournisseur restent dans [analyse-detaillee.md](analyse-detaillee.md) avec protocole et avertissements. Aucun score de sources hétérogènes n’est moyenné. Les prix sont des snapshots catalogue au 17 juillet 2026, complétés par une ré-vérification ciblée le 21 juillet 2026 (modèles de tête et AI Act); remises, contrats et taxes varient.
...
Registre complet, dates et URL exactes: [sources.md](sources.md). Les prix et capacités sont issus en priorité des identifiants S01–S59; S60 est un signal de marché indépendant; S61–S65 couvrent la ré-vérification ciblée du 21 juillet 2026 (GPT-5.6, Fable 5/Mythos 5, Gemma 4, AI Act).
