...
Contrôle: **15 août 2026**. L’état tarifaire courant retient l’arrivée de **Gemini 3.7 Flash à 0,75/3,75 USD/M jusqu’au 31 décembre 2026**, tarif qui **double au 1er janvier 2027**, le passage en disponibilité générale de **DeepSeek V4 Pro 0813 sous licence MIT**, la sortie de **GLM-5.3 sans ses poids**, et le maintien de **Claude Sonnet 5 à 2/10 USD/M en tarif définitif**. Le comparatif couvre également **Mistral Regional Endpoints, Priority Tier et hébergement de modèles ouverts tiers**, **xAI Grok 4.6**, **OpenAI GPT-5.6-Cyber** et le palier **Ultrafast** pour GPT-5.6 Sol, ainsi que **Cohere North Mini Code** et **Gemini Omni Flash**. Voir [Prix API](#prix-api), [Exécution locale](#exécution-locale) et [Développement](#développement). Ce fichier remplace le classeur Excel demandé initialement: le dépôt a explicitement migré vers Markdown le 16 juillet 2026. Les « feuilles » sont les sections ci-dessous. Les références Sxx renvoient à [sources.md](sources.md).

> ⚠️ **Niveau de preuve de cette édition.** La politique réseau sortante bloque la majorité des domaines éditeurs et **la totalité des six points d’entrée de veille quotidienne**: sur 44 sources historiques, **4 répondent**. Les tarifs Claude sont établis en **source primaire ouverte directement** (page tarifaire et notes de version de l’API); les autres lignes sont établies par convergence de sources indépendantes et **plafonnées à 89/100**, ou conservent le niveau de preuve de leur dernier contrôle effectif. Voir [sources.md](sources.md). Revérification recommandée avant tout engagement contractuel ou budgétaire.
