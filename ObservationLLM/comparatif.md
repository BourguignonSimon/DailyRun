...
Mise à jour: **25 juillet 2026** (édition précédente: 17 juillet 2026). Ce fichier remplace le classeur Excel demandé initialement: le dépôt a explicitement migré vers Markdown le 16 juillet 2026. Les « feuilles » sont les sections ci-dessous. Les références Sxx renvoient à [sources.md](sources.md).
...
|---:|---|---|---|---|---|---|---|
| 1 | OpenAI | Modèles + app + API + agent code | GPT-5.6 (Luna/Terra/Sol), ChatGPT, Codex | Élevée | Écosystème complet et outils | Coût frontière et verrouillage | S01–S05, S61 |
| 2 | Anthropic | Modèles + app + API + agent code | Opus 5, Sonnet 5, Claude Code | Élevée | Raisonnement, code, long contexte | Prix Opus; options régionales payantes | S06–S08, S62 |
| 3 | Google | Modèles + app + API + cloud | Gemini 3.6 Flash, Gemini API | Élevée | Multimodal, 1 M, recherche | Complexité des surfaces et tarifs | S09–S11, S63 |
...
| 7 | Mistral | Modèles UE + app + API + robotique | Medium 3.5, Large, Vibe, OCR 4, Robostral | Très élevée | Acteur européen, open weight | Catalogue et licences variables | S19–S21, S67 |
| 8 | xAI (SpaceX) | Modèles + app + API | Grok 4.5 (co-entraîné avec Cursor) | Élevée | Contexte, temps réel, outils | Gouvernance et rétention à valider | S22–S24, S65 |
...
| 16 | Anysphere/Cursor | Éditeur et agents de code | Cursor (rachat SpaceX/xAI en cours, 60 Md USD) | Très élevée pour développeurs | UX agentique sur dépôt | Rachat SpaceX/xAI T3 2026; dépendance modèles/crédits | S41–S43, S66 |
...
| 19 | Moonshot/Kimi | Modèles + app + agent code | Kimi K3 (MoE 2,8 T, 1 M), Kimi Code | Moyenne | Open weight, code, agents | Offre belge, DPA et prix officiel à confirmer | S48–S51, S60, S64 |
...
Prix catalogue observés. Conversion: USD ÷ 1,1392 (BCE, 23 juillet 2026); CNY ÷ 7,7327 (14 juillet, non revérifié ce cycle). La colonne TVA est prudente: « checkout » signifie que l’inclusion doit être confirmée sur la facture belge.
...
|---|---:|---:|---:|---:|---:|---:|---|---|---|
| OpenAI GPT-5.6 Sol (flagship) | 1 M | 5 USD | ND | 30 USD | 4,39 € | 26,33 € | Batch/Flex -50 %; Priority ×2,5 | Terra 2,50/15; Luna 1/6; outils programmatiques et cache breakpoints | S01–S02, S61 |
| Anthropic Claude Opus 5, API directe | 1 M | 5 USD | lecture 0,50 USD; écritures selon durée | 25 USD | 4,39 € | 21,95 € | Batch -50 % | Prix identique à Opus 4.8; Fast mode 10/50; cache min. 512 jetons | S06–S08, S62 |
| Google Gemini 3.6 Flash | 1 M | 1,50 USD | 0,15 USD + stockage 1 USD/M/h | 7,50 USD | 1,32 € | 6,58 € | Batch/Flex ~-50 %; Priority | Sortie −16,7 % vs 3.5; ~17 % de jetons en moins; Search facturé après quota | S09–S10, S63 |
| Mistral Large | À confirmer par version | 2 USD | ND | 6 USD | 1,76 € | 5,27 € | Batch -50 % | OCR 4, audio et autres outils séparés | S19, S67 |
| xAI Grok 4.5 court | 200 k seuil | 2 USD | 0,50 USD | 6 USD | 1,76 € | 5,27 € | Batch affichable | Au-delà de 200 k: 4/12; variante rapide 4/18 | S22, S65 |
...
|---|---|---|---|---|---|---|---|---:|
| OpenAI | texte, image; autres modèles audio/vidéo | Oui; outils programmatiques | Oui | File search; mémoire app | Agents SDK, Codex, orchestration multi-agents | Python, JS, .NET, Go | gpt-oss; API managée | 1 M |
...
| Kimi | Texte/image/vidéo (K3) | Oui | App/agent | Long contexte | Kimi Code + sous-agents | SDK/CLI | Oui, MIT modifiée (K3) | 1 M (K3) |
...
Les benchmarks fournisseur restent dans [analyse-detaillee.md](analyse-detaillee.md) avec protocole et avertissements. Aucun score de sources hétérogènes n’est moyenné. Les prix sont des snapshots catalogue au 25 juillet 2026; remises, contrats et taxes varient.

Contrôles effectués: 20 lignes exactes dans Vue d’ensemble; unités de prix homogènes; conversions recalculées avec S55 (1,1392 USD/EUR); liens Markdown relatifs; valeurs inconnues marquées ND/à confirmer. Les filtres, volets figés et formules Excel ne sont pas applicables à Markdown. La liste reste plafonnée à 20; aucun acteur n’a été remplacé ce cycle malgré la consolidation SpaceX/xAI–Cursor, qui n’est pas encore clôturée.

## Sources

Registre complet, dates et URL exactes: [sources.md](sources.md). Les prix et capacités sont issus en priorité des documents officiels S01–S59 et S61–S68; S60 et les sources presse S64–S66 servent de signaux de marché indépendants pour des faits très récents.
