...
Mise à jour: **23 juillet 2026** (re-vérification; base initiale du 17 juillet). Ce fichier remplace le classeur Excel demandé initialement: le dépôt a explicitement migré vers Markdown le 16 juillet 2026. Les « feuilles » sont les sections ci-dessous. Les références Sxx renvoient à [sources.md](sources.md). **Note de fiabilité (23 juillet):** certains domaines officiels (OpenAI, DeepSeek, Kimi) étaient bloqués; les valeurs correspondantes portent la mention « à confirmer ».
...
|---:|---|---|---|---|---|---|---|
| 1 | OpenAI | Modèles + app + API + agent code | GPT-5.6 Sol/Terra/Luna (à confirmer), ChatGPT, Codex | Élevée | Écosystème complet et outils | Coût frontière et verrouillage; source primaire bloquée | S01–S05, S66 |
| 2 | Anthropic | Modèles + app + API + agent code | Fable 5 (frontière), Opus 4.8, Sonnet 5, Claude Code | Élevée | Raisonnement, code, long contexte | Prix Fable 5/Opus; options régionales payantes | S06–S08, S61–S63 |
| 3 | Google | Modèles + app + API + cloud | Gemini 3.6 Flash, 3.1 Pro Preview, Gemini API | Élevée | Multimodal, 1 M, recherche | Complexité des surfaces et tarifs | S09–S11, S64 |
...
| 9 | DeepSeek | Modèles + app + API + poids | DeepSeek V4 Pro/Flash (1 M ctx) | Moyenne | Rapport coût/capacité | Région, données, disponibilité belge; grille à confirmer | S25–S26, S67 |
| 10 | Alibaba/Qwen | Modèles + cloud + poids | Qwen3.8-Max-Preview, Model Studio | Moyenne | Catalogue large, code, prix | Facturation/région et support UE; preview sans prix jeton | S27–S28, S69–S70 |
...
| 19 | Moonshot/Kimi | Modèles + app + agent code | Kimi K3 (2,8 T, 1 M ctx), Kimi Code | Moyenne | Open weight, code, agents | Offre belge, DPA et prix officiel à confirmer | S48–S51, S60, S68 |
...
Prix catalogue observés. Conversion: USD ÷ 1,1408 (22 juillet 2026); CNY ÷ 7,7255 (21 juillet 2026) [S55]. La colonne TVA est prudente: « checkout » signifie que l’inclusion doit être confirmée sur la facture belge.
...
|---|---:|---:|---:|---:|---:|---:|---|---|---|
| Anthropic Claude Fable 5 (frontière), API directe | 1 M | 10 USD | lecture 1 USD; écritures 12,50 (5 min)/20 (1 h) | 50 USD | 8,77 € | 43,83 € | Batch -50 % (5/25) | Thinking permanent; classificateurs de sûreté; tokenizer +~30 % | S61 |
| Anthropic Claude Opus 4.8, API directe | 1 M | 5 USD | lecture 0,50 USD; écritures selon durée | 25 USD | 4,38 € | 21,91 € | Batch -50 % | Résidence et fast peuvent ajouter un multiplicateur | S06–S08 |
| Anthropic Claude Sonnet 5 (prix de lancement) | 1 M | 2 USD | 0,20 USD | 10 USD | 1,75 € | 8,77 € | Batch 1/5 | Lancement jusqu’au 31 août 2026; puis 3/15 (cache 0,30) | S07–S08, S61 |
| OpenAI GPT-5.6 Sol (à confirmer) | ~1 M | 5 USD | ~0,50 USD | 30 USD | 4,38 € | 26,30 € | Batch/Flex -50 %; Priority ×2,5 | Frontière rapportée; source primaire bloquée; Terra 2,50/15, Luna 1/6 | S66 |
| Google Gemini 3.6 Flash | 1 M | 1,50 USD | 0,15 USD + stockage | 7,50 USD | 1,31 € | 6,57 € | Batch/Flex disponibles | Sortie 9→7,50 vs 3.5 Flash; Search/Maps 14 USD/1 000 après 5 000/mois | S64 |
| Mistral Large | À confirmer par version | 2 USD | ND | 6 USD | 1,75 € | 5,26 € | Batch -50 % | Medium 3.5: 1,5/7,5; OCR, audio séparés | S19 |
| xAI Grok 4.5 court | 500 k | 2 USD | 0,50 USD | 6 USD | 1,75 € | 5,26 € | Batch affichable | Long contexte 4/1/12 USD; « Grok 4.3 » est un modèle distinct 1 M | S22 |
| Moonshot Kimi K3 (à confirmer) | 1 M | 3 USD | 0,30 USD hit | 15 USD | 2,63 € | 13,15 € | À confirmer | Page officielle bloquée; corroboré multi-sources; poids ouverts ~27 juil. | S68 |
| DeepSeek V4 (Pro/Flash) | 1 M | À confirmer | À confirmer | À confirmer | ND | ND | Peak/off-peak rapporté | Alias `deepseek-chat` retirés le 24 juil. 2026; grille non lisible (domaine bloqué) | S67 |
...
| DeepSeek | Texte, selon version | Partiel | App | Cache; RAG externe | Frameworks tiers | API compatible/Anthropic | Oui selon modèle | 1 M (V4) |
...
Les benchmarks fournisseur restent dans [analyse-detaillee.md](analyse-detaillee.md) avec protocole et avertissements. Aucun score de sources hétérogènes n’est moyenné. Les prix sont des snapshots catalogue au 23 juillet 2026 (base du 17 juillet); remises, contrats et taxes varient. Les valeurs « à confirmer » n’ont pas pu être lues sur la page officielle cette exécution (domaines bloqués).
