...
Mise à jour: **4 août 2026** (édition précédente 17 juillet 2026). Ce fichier remplace le classeur Excel demandé initialement: le dépôt a explicitement migré vers Markdown le 16 juillet 2026. Les « feuilles » sont les sections ci-dessous. Les références Sxx renvoient à [sources.md](sources.md).
...
|---:|---|---|---|---|---|---|---|
| 1 | OpenAI | Modèles + app + API + agent code | GPT-5.6 Sol/Terra/Luna, ChatGPT, Codex | Élevée | Écosystème complet et outils | Coût frontière et verrouillage | S01–S02, S61 |
| 2 | Anthropic | Modèles + app + API + agent code | Opus 5, Sonnet 5, Fable 5, Claude Code | Élevée | Raisonnement, code, long contexte | Prix Opus; options régionales payantes | S06–S08, S62 |
| 3 | Google | Modèles + app + API + cloud | Gemini 3.6 Flash, 3.1 Pro, Gemini API | Élevée | Multimodal, 1 M, recherche | Complexité des surfaces et tarifs | S09–S11, S63 |
...
| 7 | Mistral | Modèles UE + app + API | Large 3, Medium 3.5, Small 4, Vibe | Très élevée | Acteur européen, open weight, prix en baisse | Catalogue et licences variables | S19–S21, S64 |
| 8 | xAI | Modèles + app + API | Grok 4.5 | Élevée | Contexte, temps réel, outils | Gouvernance et rétention à valider | S22–S24 |
| 9 | DeepSeek | Modèles + app + API + poids | DeepSeek V4 (pro/flash) | Moyenne | Rapport coût/capacité | Région, données, disponibilité belge | S25–S26, S65 |
| 10 | Alibaba/Qwen | Modèles + cloud + poids | Qwen3.5 (à confirmer), Model Studio | Moyenne | Catalogue large, code, prix | Facturation/région et support UE | S27–S28 |
...
| 19 | Moonshot/Kimi | Modèles + app + agent code | Kimi K3 (GA), K2.7, Kimi Code | Moyenne | Open weight, code, agents | Offre belge, DPA et prix officiel à confirmer | S48–S51, S60 |
...
Prix catalogue observés. Conversion: USD ÷ 1,1485 (taux BCE 31 juillet 2026); CNY ÷ 7,7327 (à confirmer). La colonne TVA est prudente: « checkout » signifie que l’inclusion doit être confirmée sur la facture belge.
...
|---|---:|---:|---:|---:|---:|---:|---|---|---|
| OpenAI GPT-5.6 Sol | 1,05 M | 5 USD | 0,50 USD | 30 USD | 4,35 € | 26,12 € | Batch/Flex -50 %; Priority ×2,5 | Terra 2/12, Luna 0,20/1,20 USD; outils séparés | S01–S02, S61 |
| Anthropic Claude Opus 5, API directe | 1 M | 5 USD | lecture 0,50 USD; écritures selon durée | 25 USD | 4,35 € | 21,77 € | Batch -50 % | Sonnet 5 intro 2/10 USD jusqu’au 31/08, puis 3/15; Fable 5 10/50 | S06–S08, S62 |
| Google Gemini 3.6 Flash | 1 M | 1,50 USD | 0,15 USD + stockage | 7,50 USD | 1,31 € | 6,53 € | Batch/Flex -50 % | 3.1 Pro 2/12 (≤200 k); grounding natif; outils séparés | S09–S10, S63 |
| Mistral Large 3 | 256 k | 0,50 USD | ND | 1,50 USD | 0,44 € | 1,31 € | Batch -50 % | Medium 3.5 orienté agents; Small 4 0,10/0,30; OCR/audio séparés | S19, S64 |
| xAI Grok 4.5 court | 500 k | 2 USD | 0,50 USD | 6 USD | 1,74 € | 5,22 € | Batch affichable | Long contexte à confirmer (baseline 4/1/12 USD) | S22 |
| DeepSeek V4 pro | 164 k | 0,435 USD | hit publié | 0,87 USD | 0,38 € | 0,76 € | À confirmer | V4-flash 0,14/0,28; alias legacy retirés le 24/07 | S25, S65 |
| Alibaba Qwen (à confirmer) | Jusqu’à 1 M | À confirmer | Remise cache publiée | À confirmer | — | — | Promotions variables | Flagship Qwen3.5 cité par traceurs; vérifier Model Studio | S27 |
...
| Moonshot Kimi K3 | 1 M | 3 USD | 0,30 USD hit | 15 USD | 2,61 € | 13,06 € | À confirmer | K2.7 Code 0,95/4,00; poids disponibles séparément | S48–S51, S60 |
...
Les benchmarks fournisseur restent dans [analyse-detaillee.md](analyse-detaillee.md) avec protocole et avertissements. Aucun score de sources hétérogènes n’est moyenné. Les prix sont des snapshots catalogue au 4 août 2026; remises, contrats et taxes varient.
...
Registre complet, dates et URL exactes: [sources.md](sources.md). Les prix et capacités sont issus en priorité des pages officielles S01–S59; S60–S67 couvrent les mouvements récents (nouvelles familles de modèles, taux de change et Digital Omnibus). Les valeurs marquées « à confirmer » n’ont pas été vérifiées sur une page officielle lors de ce contrôle.
